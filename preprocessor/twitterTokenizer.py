...
#modification
standardAbbreviations = r"""\b(?:[Vv]\.Chr|z\.Zt|[Aa]bs|[Aa]nm|[Aa]rt|[Aa]l|[Aa]pl|[Aa]z|[Bb]ek|[Bb]ros|[Bb]zw|[Cc]a|[Cc]hr|[Cc]o|[Dd]r|[Ee]ngl|[Ee]tc|[Ff]f|[Ff]r|[Gg]eb|[Gg]gf|[Ii]nsb|[Ii]ncl|[Ii]nkl|
                            [Mm]io|[Mm]ax|[Mm]in|[Mm]io|[Mm]rd|[Nn]r|[Pp]rof|[Ss]td|[Ss]og|[Ss]tr|[Tt]el|[Uu]|[Uu]sw|[Vv]|[Vv]s|[Vv]ol|[Mm]r|[Zz])\."""
...
#Known Issue: #spd- > #spd -
#Hashtag = "(^[#][\w]+|\$[0-9,.]*[0-9]|[0-9.]*[0-9][%$]|^([A-Za-z]+\.){2,})"
...
#Modification
DashesOnWords = r'''(?:[a-z][a-z'\-_]+[a-z])|(?:[\w_]+)'''  # Words with apostrophes or dashes e.g CDU-
#HtmlTags = r"""<[^>]+>"""
